<template>
  ...
  >
    ...
    <!-- المحتوى الرئيسي: هيرو + جميع المشاريع -->
    <main>
      <HeroSection 
        :title="t('allProjectsHeroTitle')" 
        :description="t('allProjectsHeroDesc')"
        :current-page="t('allProjects')"
      />
      <AllProjectsSection />
    </main>
...
import AllProjectsSection from '@/components/programs/Allprogramss.vue' // تأكد من المسار الصحيح
...
// تعريف الروابط للهيرو الخاص بصفحة "جميع المشاريع"
const heroLinks = [
  {
    text: t('home'),
